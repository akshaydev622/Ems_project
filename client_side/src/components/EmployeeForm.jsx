  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
        ...
        <div className="card p-5 sm:p-6">
            <h3 className="font-medium mb-6 pb-4 border-b border-slate-400">
                Personal Information
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                ...
                <div className="sm:col-span-2">
                    ...
                    <textarea  name="bio" required defaultValue={initialData?.bio} rows={3} className="resize-none" placeholder="Brif description...." />
                </div>
        ...
        {/* Employement Details */}
         <div className="card-3 p-5 sm:p-3">
        ...
        {/* Account setup */}
        <div className="card p-5 sm:p-6">
            <h3 className=" text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-400">
                Account Setup
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                <div className="sm:col-span-2">
