import { Heading2, Loader2, Plus, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="card max-w-lg w-full p-6 animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="block font-medium text-sm text-slate-700 mb-2">Employee</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block font-medium text-sm text-slate-700 mb-2">Month</label>
                    ...
                    <div>
                        ...
                        <input type="number" name="year" step="1" defaultValue={new Date().getFullYear()} />
                    </div>
                </div>
